...
/**
  ...
  */
@JSExportTopLevel("ExIntroductionStat")
object ExIntroductionStat {
  ...
  def refreshTypeahead = {
    val url = g.jsRoutes.controllers.ExIntroductionController.getAllNumber().url.toString
  ...
  def mySearch = {
    ...
    val url = g.jsRoutes.controllers.ExIntroductionController.getStatData().url.toString
