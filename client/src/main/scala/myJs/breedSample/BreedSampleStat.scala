...
/**
  ...
  */
@JSExportTopLevel("BreedSampleStat")
object BreedSampleStat {
  ...
  def refreshTypeahead = {
    val url = g.jsRoutes.controllers.BreedSampleController.getAllNumber().url.toString
  ...
  def mySearch = {
    ...
    val url = g.jsRoutes.controllers.BreedSampleController.getStatData().url.toString
