...
/**
  ...
  */
@JSExportTopLevel("LocalSampleManage")
object Manage {
  ...
  def deletes = {
    ...
    g.swal(dict, () => {
      ...
      val url = g.jsRoutes.controllers.adminC.LocalSampleController.deleteSamplePhenotypes().url.toString
  ...
  def operateFmt: js.Function = {
    (v: js.Any, row: js.Dictionary[js.Any]) =>
      val deleteStr = a(
        title := "删除",
        onclick := s"LocalSampleManage.delete('${row("number")}')",
        cursor.pointer,
        span(
          em(cls := "fa fa-close")
        )
      )
      val updateUrl = g.jsRoutes.controllers.adminC.LocalSampleController.updateSamplePhenotypeBefore().url.toString
      val updateStr = a(
        title := "修改",
        cursor.pointer,
  ...
  def delete(number: String) = {
    ...
    g.swal(dict, () => {
      val url = g.jsRoutes.controllers.adminC.LocalSampleController.deleteByNumber().url.toString
  ...
  def aOperateFmt: js.Function = {
    (v: js.Any, row: js.Dictionary[js.Any]) =>
      val manageUrl = g.jsRoutes.controllers.adminC.LocalSampleController.manageAppendixBefore().url.toString
      val manageStr = a(
        title := "管理",
        cursor.pointer,
