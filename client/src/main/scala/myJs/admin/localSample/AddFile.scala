...
import org.scalajs.dom.raw.{HTMLFormElement, ProgressEvent, XMLHttpRequest}
...
/**
  ...
  */
@JSExportTopLevel("LocalSampleAddFile")
object AddFile {
  ...
  def add = {
    ...
    if (valid) {
      ...
      val url = g.jsRoutes.controllers.adminC.LocalSampleController.addSamplePhenotypeByFile().url.toString
