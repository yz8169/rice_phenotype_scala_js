...
import org.scalajs.dom.raw.{FileList, HTMLFormElement, ProgressEvent, XMLHttpRequest}
...
/**
  ...
  */
@JSExportTopLevel("BreedSampleAddFile")
object AddFile {
  ...
  def add = {
    ...
    if (valid) {
      ...
      val url = g.jsRoutes.controllers.adminC.BreedSampleController.addSamplePhenotypeByFile().url.toString
