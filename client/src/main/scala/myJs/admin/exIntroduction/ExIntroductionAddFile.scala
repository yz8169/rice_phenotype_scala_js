...
/**
  ...
  */
@JSExportTopLevel("ExIntroductionAddFile")
object ExIntroductionAddFile {
  ...
  def add = {
    ...
    if (valid) {
      ...
      val url = g.jsRoutes.controllers.adminC.ExIntroductionController.addByFile().url.toString
